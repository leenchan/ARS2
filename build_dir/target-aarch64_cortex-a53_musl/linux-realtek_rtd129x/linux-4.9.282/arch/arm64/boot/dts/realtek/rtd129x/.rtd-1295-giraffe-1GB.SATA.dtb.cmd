cmd_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dtb := mkdir -p arch/arm64/boot/dts/realtek/rtd129x/ ; ccache_cc -E -Wp,-MD,arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-giraffe-1GB.SATA.dtb.d.pre.tmp -nostdinc -I./arch/arm64/boot/dts -I./arch/arm64/boot/dts/include -I./drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-giraffe-1GB.SATA.dtb.dts.tmp arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dtb -b 0 -i arch/arm64/boot/dts/realtek/rtd129x/ -Wno-unit_address_vs_reg -d arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-giraffe-1GB.SATA.dtb.d.dtc.tmp arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-giraffe-1GB.SATA.dtb.dts.tmp ; cat arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-giraffe-1GB.SATA.dtb.d.pre.tmp arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-giraffe-1GB.SATA.dtb.d.dtc.tmp > arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-giraffe-1GB.SATA.dtb.d

source_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dtb := arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dts

deps_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dtb := \
...
arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dtb: $(deps_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-giraffe-1GB.SATA.dtb)
