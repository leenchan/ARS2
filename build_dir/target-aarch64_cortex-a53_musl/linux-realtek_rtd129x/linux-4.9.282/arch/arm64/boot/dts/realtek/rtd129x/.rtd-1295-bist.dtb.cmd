cmd_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dtb := mkdir -p arch/arm64/boot/dts/realtek/rtd129x/ ; ccache_cc -E -Wp,-MD,arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-bist.dtb.d.pre.tmp -nostdinc -I./arch/arm64/boot/dts -I./arch/arm64/boot/dts/include -I./drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-bist.dtb.dts.tmp arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dtb -b 0 -i arch/arm64/boot/dts/realtek/rtd129x/ -Wno-unit_address_vs_reg -d arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-bist.dtb.d.dtc.tmp arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-bist.dtb.dts.tmp ; cat arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-bist.dtb.d.pre.tmp arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-bist.dtb.d.dtc.tmp > arch/arm64/boot/dts/realtek/rtd129x/.rtd-1295-bist.dtb.d

source_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dtb := arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dts

deps_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dtb := \
...
arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dtb: $(deps_arch/arm64/boot/dts/realtek/rtd129x/rtd-1295-bist.dtb)
