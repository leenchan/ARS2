...
enum opt_code
{
  ...
  OPT_mbionic = 1157,                        /* -mbionic */
  OPT_mcmodel_ = 1158,                       /* -mcmodel= */
  OPT_mcpu_ = 1159,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1160,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1161,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1162,             /* -mgeneral-regs-only */
  OPT_mglibc = 1163,                         /* -mglibc */
  OPT_mlittle_endian = 1164,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1165,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1166,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1167,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1168,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1169,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1170,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1171,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1172,          /* -msign-return-address= */
  OPT_mstrict_align = 1173,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1174,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1175,                     /* -mtls-size= */
  OPT_mtune_ = 1176,                         /* -mtune= */
  OPT_muclibc = 1177,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1178,             /* -mverbose-cost-dump */
  OPT_n = 1179,                              /* -n */
  OPT_no_canonical_prefixes = 1180,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1181,              /* -no-integrated-cpp */
  OPT_no_pie = 1182,                         /* -no-pie */
  ...
  OPT_profile = 1209,                        /* -profile */
  OPT_pthread = 1210,                        /* -pthread */
  OPT_quiet = 1211,                          /* -quiet */
  OPT_r = 1212,                              /* -r */
  OPT_rdynamic = 1213,                       /* -rdynamic */
